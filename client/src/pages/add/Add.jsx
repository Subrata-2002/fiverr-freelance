...
const Add = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setUploading(false);
      dispatch({ type: "ADD_IMAGES", payload: { cover: cover, images } });
      ...
      <div className="container">
        ...
        <div className="sections">
          ...
          <div className="left">
            ...
            <textarea name="desc" placeholder="Brief description to introduce your service to customers" id="" cols="30" rows="10" onChange={handleChange}></textarea>
          ...
          <div className="right">
            ...
            <textarea name="shortDesc" placeholder="Short description of your service" id="" cols="30" rows="10" onChange={handleChange}></textarea>
